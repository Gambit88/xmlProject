...
class Paper(models.Model):
    ...
    author = models.OneToOneField(User, on_delete=models.CASCADE, related_name="paper_author")
    reviewer = models.ManyToManyField(User, related_name="paper_reviewer")
    publisher = models.OneToOneField(User, on_delete=models.CASCADE, related_name="paper_publilsher")
